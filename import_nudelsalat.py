...
def import_recipe():
    ...
    try:
        recipe_name = "Italienischer Nudelsalat mit Rucola und getrockneten Tomaten"
        ...
        recipe_data = (
            recipe_name,
            "Mediterraner Nudelsalat mit Rucola, getrockneten Tomaten, Cherrytomaten und Mozzarella in Balsamico-Tomaten-Dressing",
            "Hauptgericht"
        )
        ...
        ingredients_data = [
            ('Pasta', 58.33, 'g'),
            ('Rucola', 0.33, 'Portion'),
            ('Tomaten (passiert)', 25, 'g'),
            ('Balsamico', 0.67, 'EL'),
            ('Olivenöl', 0.67, 'EL'),
            ('Zucker', 0.17, 'TL'),
            ('Salz', 1, 'Prise'),
            ('Pfeffer', 1, 'Prise'),
            ('Tomaten (getrocknet in Öl)', 16.67, 'g'),
            ('Cherrytomaten', 41.67, 'g'),
            ('Mozzarella', 0.17, 'Stück')
        ]
